...
AShopDemoCharacter::AShopDemoCharacter()
{
...
void AShopDemoCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AShopDemoCharacter::TurnAtRate);
...
void AShopDemoCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void AShopDemoCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
